	...
	<section class="sample-text-area">
		<div class="container">
			...
			<p class="sample-text">
				...
				film to show off their creative prowess. Many have great ideas and want to âwowâ the<sup>Superscript</sup> scene,
				or video renters with their big project. But once you have the<sub>Subscript</sub> âin the canâ (no easy feat), how
				do you move from a <del>Strike</del> through of master DVDs with the <u>âUnderlineâ</u> marked hand-written title
	...
	<div class="whole-wrap pb-100">
		<div class="container">
			<div class="section-top-border">
				...
				<div class="row">
					<div class="col-md-3">
						<img src="/haroobang/resources/img/elements/d.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="row">
					<div class="col-md-9">
						<p class="text-right">Over time, even the most sophisticated, memory packed computer can begin to run slow if we
							donât do something to prevent it. The reason why has less to do with how computers are made and how they age and
						...
						<p class="text-right">Before we discuss all of the things that could be affecting your PCâs performance, letâs
				...
				<div class="row">
					<div class="col-lg-12">
						<blockquote class="generic-blockquote">
							âRecently, the US Federal government banned online casinos from operating in America by making it illegal to
							transfer money to them through any US bank or payment system. As a result of this law, most of the popular
							online casino networks such as Party Gaming and PlayTech left the United States. Overnight, online casino
							players found themselves being chased by the Federal government. But, after a fortnight, the online casino
							industry came up with a solution and new online casinos started taking root. These began to operate under a
				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="/haroobang/resources/img/elements/f1.jpg" alt="flag">Canada</div>
						...
						<div class="table-row">
							...
							<div class="country"> <img src="/haroobang/resources/img/elements/f2.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="/haroobang/resources/img/elements/f3.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="/haroobang/resources/img/elements/f4.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="/haroobang/resources/img/elements/f5.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="/haroobang/resources/img/elements/f6.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="/haroobang/resources/img/elements/f7.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="/haroobang/resources/img/elements/f8.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
			...
			<div class="section-top-border">
				...
				<div class="row gallery-item">
					<div class="col-md-4">
						<a href="/haroobang/resources/img/elements/g1.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(/haroobang/resources/img/elements/g1.jpg);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="/haroobang/resources/img/elements/g2.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(/haroobang/resources/img/elements/g2.jpg);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="/haroobang/resources/img/elements/g3.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(/haroobang/resources/img/elements/g3.jpg);"></div>
						</a>
					</div>
					<div class="col-md-6">
						<a href="/haroobang/resources/img/elements/g4.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(/haroobang/resources/img/elements/g4.jpg);"></div>
						</a>
					</div>
					<div class="col-md-6">
						<a href="/haroobang/resources/img/elements/g5.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(/haroobang/resources/img/elements/g5.jpg);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="/haroobang/resources/img/elements/g6.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(/haroobang/resources/img/elements/g6.jpg);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="/haroobang/resources/img/elements/g7.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(/haroobang/resources/img/elements/g7.jpg);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="/haroobang/resources/img/elements/g8.jpg" class="img-pop-up">
							<div class="single-gallery-image" style="background: url(/haroobang/resources/img/elements/g8.jpg);"></div>
						</a>
					</div>
				</div>
			</div>
